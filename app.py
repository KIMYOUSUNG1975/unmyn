      ...
      const response = await axios.post(
        ...
        },
        {
          headers: {
            ...
            'Authorization': 'Bearer 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' // ← 여기만 수정하세요!
          }
        }
      );
